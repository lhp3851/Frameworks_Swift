...
A frameworks for swift, which based on RxSwift.
  ...
  s.subspec 'Componnets' do |componnets|
    componnets.dependency 'Frameworks_Swift/Core'
    componnets.dependency 'SnapKit', '~> 5.0.1'
    componnets.source_files = 'Frameworks_Swift/Classes/Componnets/**/*'
    s.resource_bundles = {
     'Componnets' => ['Frameworks_Swift/Assets/Componnets/*.png']
    }
  end
